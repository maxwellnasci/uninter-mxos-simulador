/* ================================================================
   MXOS — Seed: Popular banco com as 360 questões
   ================================================================ */
const { getDatabase, closeDatabase } = require('./database');

// ================================================================
// DADOS — 12 AULAS COM 30 QUESTÕES CADA
// ================================================================
...
const AULA12 = {
  ...
  const aulas = [AULA01, AULA02, AULA03, AULA04, AULA05, AULA06, AULA07, AULA08, AULA09, AULA10, AULA11, AULA12];
